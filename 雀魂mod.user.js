    ...
    setTimeout(function() {
        ...
        game.Tools.get_chara_audio = function(t, e) {
          if (e && "" != e) {
            ...
            for (
              ...
              a[o].type == e && a[o].level_limit <= r && s.push(o);
            if (0 == s.length) return null;
            var l = s[Math.floor(Math.random() * s.length)];
            return {
              path: a[l].path,
              volume: view.AudioMgr.getCVmute(n.id)
                ? 0
      ...
      !(function(t) {
        var e = (function() {
          function e(t) {
            var e = this;
            (this.desktop_default =
              "myres2/tablecloth/tablecloth_default/preview.jpg"),
          ...
          return (
            ...
            (e.prototype.change_tab = function(e) {
              var i = t.UI_Bag.find_items_by_category(
                t.EItemCategory.common_view
              );
              (i = i.sort(function(t, e) {
                ...
                this.scrollview.reset(),
                (this.select_index = -1),
                (this.btn_tablecloth.getChildByName("inchoose").visible =
                  1 == e),
                (this.btn_cardback.getChildByName("inchoose").visible = 2 == e);
              for (var n = 0; n < i.length; n++) {
                cfg.item_definition.item.get(i[n].item_id).type == e &&
                  (this.items.push(i[n]),
                  i[n].item_id == game.GameUtility.get_common_view_id(e) &&
                    (this.select_index = this.items.length - 1));
              }
              this.scrollview.addItem(this.items.length),
                this._on_select_change(),
                1 == e
                  ? this._refresh_mjp_view(
                      game.GameUtility.get_common_view_id(game.ECommonView.mjp)
                    )
                  : this._refresh_desktop_view(
                      game.GameUtility.get_common_view_id(
                        game.ECommonView.desktop
                      )
                    );
            }),
            (e.prototype.render_item = function(e) {
              ...
              GameMgr.Inst.commonview_slot[o.type] == s.item_id
                ? (c.visible = !0)
                : (c.visible = !1),
                r.skin ||
                  (r.skin = new t.UI_Item_Skin(h.getChildByName("icon"))),
                r.skin.setSkin(o.icon);
            }),
            (e.prototype._on_select_change = function() {
              if (
                this.select_index >= 0 &&
                this.select_index < this.items.length
              ) {
                var t = this.items[this.select_index];
                game.GameUtility.get_common_view_id(this.tab_index) == t.item_id
                  ? (this.btn_save.getChildByName(
                      "info"
                    ).text = game.Tools.strOfLocalization(2034))
                  : (this.btn_save.getChildByName(
                      "info"
                    ).text = game.Tools.strOfLocalization(2035)),
                  (this.btn_save.visible = !0),
                  1 == this.tab_index
                    ? this._refresh_desktop_view(t.item_id)
                    : this._refresh_mjp_view(t.item_id);
              } else
                (this.btn_save.visible = !1),
                  1 == this.tab_index
                    ? this._refresh_desktop_view(0)
                    : this._refresh_mjp_view(0);
            }),
          ...
          return (
            ...
            (n.prototype.onCreate = function() {
              ...
              for (
                var i = function(t) {
                    n.tabs.push(
                      n.container_content.getChildByName("tabs").getChildAt(t)
                    ),
      ...
      function e(e) {
        ...
        (this.money = null),
          ...
          (this.money = new t.UI_Money(
            e,
            Laya.Handler.create(o.Inst, o.Inst.Hide, null, !1),
            Laya.Handler.create(
              this,
              function() {
          ...
          (this.btn_playerinfo.clickHandler = Laya.Handler.create(
            this,
            function() {
      ...
      function e(e) {
        (this.me = e),
          ...
          (this.btn_yibanchang.clickHandler = Laya.Handler.create(
            this,
            function() {
              o.Inst.setPage(1), GameMgr.Inst.BehavioralStatistics(1);
            },
            null,
            !1
          )),
          (this.btn_yourenfang.clickHandler = Laya.Handler.create(
            this,
            function() {
              o.Inst.setPage(2), GameMgr.Inst.BehavioralStatistics(2);
            },
            null,
            !1
          )),
          (this.btn_dajiangsai.clickHandler = Laya.Handler.create(
            ...
            function() {
              "chs" == GameMgr.client_language
                ? (GameMgr.Inst.BehavioralStatistics(3), o.Inst.setPage(3))
                : t.UIMgr.Inst.ShowErrorInfo(
                    game.Tools.strOfLocalization(2749)
                  );
            },
            null,
            !1
          ...
          (this.btn_yibanchang.visible = !1),
            ...
            Laya.timer.once(t, this, function() {
              view.AudioMgr.PlayAudio(104),
                ...
                (e.btn_yibanchang.scaleX = 0.2),
                (e.btn_yibanchang.scaleY = 0.2),
            ...
            Laya.timer.once(t + 100, this, function() {
              view.AudioMgr.PlayAudio(104),
                ...
                (e.btn_dajiangsai.scaleX = 0.2),
                (e.btn_dajiangsai.scaleY = 0.2),
            ...
            Laya.timer.once(t + 200, this, function() {
              view.AudioMgr.PlayAudio(104),
                ...
                (e.btn_yourenfang.scaleX = 0.2),
                (e.btn_yourenfang.scaleY = 0.2),
                    ...
                    function() {
                      if (!i.locking) {
                        ...
                        a &&
                          ...
                          a &&
                            c.glimit_floor &&
                            n.gold < c.glimit_floor &&
                            ((a = !1), (r = game.Tools.strOfLocalization(101))),
                          a &&
                            -1 !== c.glimit_ceil &&
                            n.gold > c.glimit_ceil &&
                            ((a = !1), (r = game.Tools.strOfLocalization(102))),
                          a &&
                            c.level_limit &&
                            n.level.id < c.level_limit &&
                            ((a = !1), (r = game.Tools.strOfLocalization(103))),
                          a &&
                            c.level_limit_ceil &&
                            n.level.id > c.level_limit_ceil &&
                            ((a = !1), (r = game.Tools.strOfLocalization(103))),
              ...
              (h.p1
                ...
                (h.p1
                  ...
                  function() {
                    i.locking ||
                      t.UI_InfoLite.Inst.show(
                        game.Tools.strOfLocalization(2 + e)
                      );
                  },
                  null,
                  !1
      ...
      return (
            ...
            Laya.timer.once(t, this, function() {
              (e.me.visible = !0),
                ...
                Laya.timer.once(100, e, function() {
                  (e.p0.visible = !0), o.Inst.me.YB2in.play(0, !1);
                }),
        ...
        (e.prototype.onShow1 = function() {
          ...
          for (var n = 0; n < i.length; n++)
            this.p1
              .getChildByName("content")
              .getChildByName("btn" + n)
              .getChildByName(
                "flag_yuyue"
              ).visible = t.UI_PiPeiYuYue.Inst.matchYuYued(i[n].id);
        }),
      ...
      return (
        ...
        (e.prototype.reset = function() {
          for (var t = 0; t < this.btns.length; t++)
            (this.btns[t].visible = !0), (this.btns[t].alpha = 1);
          this.me.getChildByName("title").alpha = 1;
        }),
        (e.prototype.onDisable = function(t) {
          var e = this;
      ...
      return (
        ...
        (l.prototype.onCreate = function() {
          ...
          (this.top = new e(this.me.getChildByName("container_top"))),
            ...
            (this.me
              ...
              function() {
                l.login_helloed &&
                  (o.sound_channel ? o.stopsay() : o.say("lobby_normal"));
              },
              null,
              !1
            ));
        ...
        (l.prototype.showEnter = function() {
          ...
          this.refreshInfo(),
            ...
            l.login_helloed ||
              Laya.timer.once(500, this, function() {
                (l.login_helloed = !0), t.say("lobby_playerlogin");
              });
        }),
            ...
            (i.prototype.onBtnConfrim = function() {
              ...
              if (!this.locking && "" != this.input.text) {
                ...
                if (a == i.length) {
                  ...
                  if (
                    this.have_invalid_char(s) ||
                    t.UI_Entrance.Accountforbidden(s)
                  )
                    this.no.visible = !0;
                    ...
                    (t.UI_Sushe.main_character_id =
                      t.UI_Sushe.characters[h].charid),
                  ...
                  t.UIMgr.Inst.ShowErrorInfo(
                    game.Tools.strOfLocalization(2750)
                  );
              }
            }),
            i
            ...
            app.NetAgent.sendReq2Lobby(
              ...
              function(e, n) {
                e || n.error
                  ...
                  : (app.Log.log(JSON.stringify(n)), i.detail_data.setData(n));
              }
            ),
            ...
            return (
                ...
                app.NetAgent.sendReq2Lobby(
                  ...
                  function(n, a) {
                    if (n || a.error)
                      ...
                      if (
                        (app.Log.log(
                          "fetchCharacterInfo: " + JSON.stringify(a)
                        ),
                        ...
                        for (var j = 1; j <= 8; j++) {
                          ...
                          i.characters.push({
                            ...
                            exp: 0,
                            views: [
                              { slot: 1, item_id: setitemlizhibang },
                              { slot: 2, item_id: setitemhupai },
                              { slot: 3, item_id: setlizhi },
                              { slot: 4, item_id: setshou },
                              { slot: 5, item_id: setmusic }
                            ],
                            skin: skin,
                            is_upgraded: 1,
                        ...
                        if (this.characters[s].charid == n[a].charid) {
                          (this.characters[s] = n[a]),
                            t.UI_Sushe_Visit.Inst &&
                              ...
                              (t.UI_Sushe_Visit.Inst.chara_info = this.characters[
                                s
                              ]),
                            (r = !0);
                          break;
              ...
              (n.prototype.onCreate = function() {
                ...
                (this.contianer_illust = this.me.getChildByName("illust")),
                  ...
                  (this.label_cv = this.container_name.getChildByName(
                    "label_CV"
                  )),
                  (this.origin_illust_x = this.contianer_illust.x),
                  (this.container_page = this.me.getChildByName(
                    "container_page"
                  )),
              ...
              (n.prototype.show_page_visit = function(t) {
                this.page_visit_character.show(
                  n.characters[this.select_index],
                  t
                );
              }),
              (n.prototype.change_select = function(e) {
                ...
                (this.label_name.text = cfg.item_definition.character.get(
                  i.charid
            ...
            (i.prototype.onDisable = function() {
              for (var e = 0; e < t.UI_Sushe.characters.length; e++)
                Laya.loader.clearTextureRes(
                  cfg.item_definition.skin.get(t.UI_Sushe.characters[e].skin) +
                    "/bighead.png"
                );
            }),
        ...
        var e = (function() {
            function t(t) {
              ...
              (this.bg_hearts = this.me.getChildByName("bg_hearts")),
                (this.exp_limits = []);
              for (var n = 0; n < 5; n++)
                this.exp_limits.push(
                  cfg.level_definition.character.find(n + 1).exp
                );
              (this.btn_heart = this.me.getChildByName("btn_heart")),
                (this.label_val = this.container_hearts.getChildByName(
                  "heartval"
                )),
          ...
          i = (function() {
            function e(t, e, i) {
              ...
              (this.items = []),
                ...
                (this.scrollview = this.content.scriptMap[
                  "capsui.CScrollView"
                ]),
                this.scrollview.init_scrollview(
                ...
                (this.container_qiyue = this.content.getChildByName(
                  "page_qiyue"
                )),
                (this.container_gift = this.content.getChildByName(
                  "page_gift"
                )),
            ...
            return (
              ...
              (e.prototype.change_tab = function(e) {
                ...
                if (
                  ...
                  if (
                    ...
                    var u = this.container_qiyue.getChildByName(
                        "container_tupo_btn"
                      ),
                      _ = u.getChildByName("send");
                    (_.clickHandler = Laya.Handler.create(
                      this,
                      this._tupo,
                      null,
                      !1
              ...
              (e.prototype.render_item_qiyue = function(e, i) {
                ...
                (r.visible = !0),
                  (r.getChildByName("count_need").text =
                    "/" + n.need.toString());
                            ...
                            if (
                              ...
                              if (s.level > e.block_exp.current_level) {
                                ...
                                if (
                                  ...
                                  var _ = "";
                                  _ =
                                    cfg.item_definition.character.get(i)
                                      .favorite ==
                                    cfg.item_definition.item.get(n).type
                                      ? "lobby_gift_favor"
                                      : "lobby_gift";
                                  var d = view.AudioMgr.PlayCharactorSound(
                                    e.chara_info,
                                    _,
                                    Laya.Handler.create(e, function() {
                              ...
                              for (
                                var f = 0;
                                f < t.UI_Sushe.characters.length;
                                f++
                              )
          ...
          n = (function() {
            function n(n) {
              ...
              for (var s = 0; s < 20; s++)
                this.emos.push(
                  new t.UI_Character_Emo(
                    r.scriptMap["capsui.UICopy"].getNodeClone()
                  )
                ),
              ...
              (this.content.getChildByName("container_emj").height = 652),
                ...
                (this._scrollbar = this.container_intro.getChildByName(
                  "scrollbar"
                )),
                (this._scrollpoint = this._scrollbar.getChildByName(
                  "scrollpoint"
                )),
                this._scrollbar &&
                  ...
                  this.content.vScrollBar.on("change", this, function() {
                    var t =
                      a.content.vScrollBar.value / a.content.vScrollBar.max;
            ...
            return (
              (n.prototype.show = function(t) {
                ...
                for (o = 0; o < 12; o += 2) {
                  ...
                  e.getChildAt(o + 1).x =
                    a.textField.textWidth * a.scaleX + a.x + 10;
                }
                  ...
                  for (o = 0; o < l.length; o++) {
                    ...
                    1 == h.unlock_type
                      ? r.push({
                          sub_id: h.sub_id,
                          unlock_desc:
                            h["unlock_desc_" + GameMgr.client_language],
                          time_limit: !1,
                          after_unlock_desc: ""
                        })
                      : 2 == h.unlock_type &&
                  ...
                  if (o >= r.length) this.emos[o].me.visible = !1;
                    ...
                    (this.emos[o].me.visible = !0),
                      ...
                      s.hasOwnProperty(u.toString())
                        ? ((this.emos[o].me.getChildByName(
                            "lock"
                          ).visible = !1),
                          (this.emos[o].me.getChildByName(
                            "time_limit"
                          ).visible = c.time_limit),
                          c.after_unlock_desc
                            ? ((this.emos[o].me.getChildByName(
                                "info"
                              ).visible = !0),
              ...
              (t.prototype.render_item = function(t) {
                ...
                -1 == i || 0 == i
                  ? ((a.getChildByName("icon").skin = game.Tools.localUISrc(
                    ...
                    (a.getChildByName(
                      "desc"
                    ).text = game.Tools.strOfLocalization(411 + t)))
                  : (game.LoadMgr.setImgSkin(
                    ...
                    (a.getChildByName(
                      "desc"
                    ).text = cfg.item_definition.item.get(i)[
                      "name_" + GameMgr.client_language
                    ]));
              }),
              ...
              (e.prototype.render_item = function(t) {
                ...
                (s.skin = game.Tools.localUISrc(
                  this.current_play_index == i
                    ? "myres/sushe/bf_pause.png"
                    : "myres/sushe/bf_play.png"
                )),
                    ...
                    function() {
                      if (e.current_play_index == i)
                        e.current_soundchannel &&
                          ...
                          Laya.SoundManager.removeChannel(
                            e.current_soundchannel
                          ),
                        ...
                        (e.current_play_index = i),
                          ...
                          (e.current_soundchannel = Laya.SoundManager.playSound(
                ...
                this.chara_info.level >= a.level_limit
                  ...
                  : ((o.visible = !0),
                    ...
                    (o.getChildByName(
                      "info"
                    ).text = game.Tools.strOfLocalization(2192, [
            ...
            return (
              ...
              (e.prototype.render_item = function(e) {
                ...
                (s.clickHandler = Laya.Handler.create(
                  ...
                  r.icon ||
                    (r.icon = new t.UI_Item_Skin(s.getChildByName("icon"))),
                  r.icon.setSkin(
                    cfg.item_definition.item.get(this.items[n]).icon
                  );
          ...
          o = (function() {
            ...
            return (
              ...
              (e.prototype.render_item = function(t) {
                ...
                game.LoadMgr.setImgSkin(
                  r,
                  cfg.item_definition.item.get(this.items[i]).icon
                );
                a.getChildByName("using").visible =
                  ...
                  function() {
                    i == e.current_listening
                      ...
                      : ((e.current_listening = i),
                        view.AudioMgr.PlayLiqiBgm(
                          cfg.item_definition.item.get(e.items[i]).sargs[0]
                        )),
            ...
            return (
              ...
              (i.prototype.onCreate = function() {
                  ...
                  var i = function(t) {
                      "chs" == GameMgr.client_language
                        ...
                        (c.tabs[t].clickHandler = Laya.Handler.create(
                          ...
                          function() {
                            e.locking ||
                              (e.current_page != t && e.change_page(t));
                          },
                          null,
                          !1
                        ));
                ...
                (this.page_intro = new n(
                  ...
                  (this.pop_effect = new s(
                    this.me.getChildByName("pop_effect")
                  )),
                  (this.pop_bgm = new o(this.me.getChildByName("pop_bgm"))),
                  (this.pop_skin = new l(this.me.getChildByName("pop_skin"))),
                  (this.info_levelup = new h(
                    this.me.getChildByName("levelup")
                  ));
              }),
                  ...
                  i &&
                    Laya.timer.once(150, this, function() {
                      n.chara_info.is_upgraded
                        ? n.info_levelup.show(
                            game.Tools.strOfLocalization(2196)
                          )
                        : n.info_levelup.show(
            ...
            return (
              (e.prototype.show = function() {
                ...
                (this.locking = !0),
                  ...
                  (this.sortlist = []);
                for (
                  var i = game.FriendMgr.friend_list, n = 0;
                  n < i.length;
                  n++
                )
            ...
            return (
                  ...
                  for (i = 0; i < t.update_list.length; i++) {
                    for (
                      ...
                      if (this.players[s] && this.players[s].account_id == a) {
                        n.avatar_id &&
                          (this.players[s].avatar_id = n.avatar_id),
                          n.title && (this.players[s].avatar_id = n.title),
                          n.nickname &&
                            (this.players[s].avatar_id = n.nickname),
              ...
              (n.prototype.onBeKictOut = function() {
                this.resetData(),
                  this.enable &&
                    ...
                    (t.UI_Lobby.Inst.enable = !0),
                    t.UIMgr.Inst.ShowErrorInfo(
                      game.Tools.strOfLocalization(52)
                    ));
              }),
              (n.prototype.onCreate = function() {
                var i = this;
                ...
                for (
                  var a = function(e) {
                      ...
                      (s.index = e),
                        ...
                        (s.container_illust = a.getChildByName(
                          "container_illust"
                        )),
                ...
                (this.btn_add_robot.clickHandler = Laya.Handler.create(
                  ...
                  function() {
                    i.locking ||
                      Laya.timer.currTimer < o ||
                      ((o = Laya.timer.currTimer + 1e3),
                      app.NetAgent.sendReq2Lobby(
                        "Lobby",
                        "modifyRoom",
                        {
                      ...
                      (this.btn_copy_link.clickHandler = Laya.Handler.create(
                        ...
                        function() {
                          Laya.PlatformClass.createClass(
                            ...
                            t.UI_FlyTips.ShowTips(
                              game.Tools.strOfLocalization(2125)
                            );
                        },
                        null,
                        !1
              ...
              (n.prototype.show = function() {
                ...
                game.Scene_Lobby.Inst.change_bg("indoor", !1),
                  ...
                  (this.pre_choose = null);
                for (h = 0; h < 4; h++)
                  this.player_cells[h].container.visible =
                    h < this.max_player_count;
                ...
                if (n) {
                  ...
                  if (
                    ...
                    null != n.fandian &&
                      i.push(
                        game.Tools.strOfLocalization(2094) + ":" + n.fandian
                      ),
                    null != n.dora_count)
                  )
                    switch (n.dora_count) {
